...
export const appRouter = [
    {
        ...
        children: [
			...
			{
				path: '/component/split-pane-page',
				icon: 'ios-pause',
				name: 'split-pane-page',
				title: 'split-pane',
				component: () =>
   	...
   	},
	{
        ...
        children: [
            { 	
            	...
            	name: 'mycase1', 
            	component: () => 
            		import('@/views/mycase/mycase1.vue') 
            },{ 	
            	path: 'mycase2',
            	title: '案例2', 
            	name: 'mycase2', 
            	component: () => 
            		import('@/views/mycase/mycase2.vue') 
            }
        ]
    }
];
